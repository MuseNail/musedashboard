...
> **Status: the build is LIVE — this copy is the original locked plan.** The authoritative version of this document (with the build progress log) lives in the `MuseNail/BackOffice` repo. App: `musenail.github.io/BackOffice/` (v0.12.0; M0–M10 + extras done; remaining: M11 — blocked on this repo's §13, see `PRIORITIES.md` #2 — then M12, M13).
